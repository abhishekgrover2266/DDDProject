...
using DDDProject.Infrastructure.Repository;
...
namespace DDDProject
{
    public class Startup
    {
        ...
        {            
            ...
            {
                c.SwaggerDoc("v1", new OpenApiInfo { Title = "DDDProject", Version = "v1" });
            });
        ...
        public void Configure(IApplicationBuilder app, IWebHostEnvironment env)
        {
            if (env.IsDevelopment())
            {
                ...
                app.UseSwagger();
                app.UseSwaggerUI(c => c.SwaggerEndpoint("/swagger/v1/swagger.json", "DDDProject v1"));
            }
